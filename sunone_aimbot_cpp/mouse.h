...
public:
    MouseThread(double screenWidth, double screenHeight, double dpi, double sensitivity, double fovX, double fovY, double minSpeedMultiplier, double maxSpeedMultiplier, double predictionInterval);
